...
import { WomSulawesiRefcekData } from '../types';
...
const WomSulawesiPreview: React.FC<{ data: WomSulawesiRefcekData | null }> = ({ data }) => {
    if (!data) {
        return (
            ...
            <main>
                <Section title="A. Status Kandidat">
                    <div className="col-span-full">
                        ...
                        <RadioDisplay label="WOM to Outsourcing" checked={data.statusKandidat === 'WOM to Outsourcing'} />
                    </div>
                </Section>
                ...
                <Section title="F, G. Kehadiran & Kesehatan">
                 ...
                 <Section title="H, I, J. Relasi, Integritas & Performance">
                ...
                <Section title="L. Akun Media Sosial">
                    <DataPair label="Alamat Akun">{data.akunMedsosAlamat}</DataPair>
                    <DataPair label="Status Akun" fullWidth>{`${data.akunMedsosStatus.join(', ')}${data.akunMedsosLainnya ? ` (Lainnya: ${data.akunMedsosLainnya})` : ''}`}</DataPair>
                </Section>
                <Section title="M, N, O. Evaluasi & Rekomendasi">
                    <DataPair label="Kelebihan Kandidat (M)" fullWidth>{data.kelebihanKandidat}</DataPair>
                    <DataPair label="Kekurangan Kandidat (N)" fullWidth>{data.kekuranganKandidat}</DataPair>
                    <DataPair label="Rekomendasi (O)">{data.rekomendasi}</DataPair>
...
export default WomSulawesiPreview;